...
'newsfeed:filter:title' => "Configuration de votre fil de nouvelles",
  ...
  'ps:all-star' => "Félicitations! Vous êtes une vedette étoile.",
  ...
  'confirm' => 'Confirmer',
  'dept:saved' => '%s est sauvegardé comme étant votre ministère actuel',
  ...
  'friends:none' => "Ce membre n'a pas encore ajouté de collègues.",
  'friends:none:you' => "Vous n'avez pas encore de collègues !",
  ...
  'friends:collections:members' => "Membres du cercles",
  'friends:collections:edit' => "Modifier la liste de collègues",
  'friends:collections:edited' => "Liste sauvegardée",
  'friends:collection:edit_failed' => 'Impossible de sauvegarder cette liste.',
