...
$french = array(
    ...
    'email_change_confirmation:request:message' => "Bonjour %s,

Vous avez demandé le changement de votre adresse de courriel sur %s vers cette adresse de courriel.
...
%s",
    ...
    'email_change_confirmation:success:message' => "Bonjour %s,

Votre adresse de courriel sur %s a été changée.
