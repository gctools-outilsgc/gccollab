...
echo elgg_view('input/submit', array('value' => elgg_echo('linkedin:submit'), 'class' => 'btn-primary pull-right mls', 'onclick' => 'ga(\'send\', \'event\', {\'eventCategory\': \'LinkedIn\',\'eventAction\': \'Save\'});'));
