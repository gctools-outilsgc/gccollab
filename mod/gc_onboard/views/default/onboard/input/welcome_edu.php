...
echo '<div class="gcconnex-education-entry" data-guid="' . $guid . '">'; // education entry wrapper for css styling
    ...
    // enter start date
    /*
    echo '<div class=""><h4>' . elgg_echo('gcconnex_profile:education:start') . '</h4>';
    echo '<div class="col-sm-6"><label for="startdate-' . $guid . '" class="gcconnex-profile-field-title">' . elgg_echo('gcconnex_profile:education:start_month') . '</label>';
    ...
    echo '</div><div class="col-sm-6"><label for="start-year-' . $guid . '">' . elgg_echo('gcconnex_profile:education:start_year') . '</label>' . elgg_view("input/text", array(
            'name' => 'start-year',
            'id' => 'start-year-' . $guid,
